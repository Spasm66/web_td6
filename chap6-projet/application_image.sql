...
CREATE TABLE auteurs(IdAuteur INT SERIAL PRIMARY KEY, Nom VARCHAR (20), Prenom VARCHAR (20));
INSERT INTO auteurs (Nom, Prenom) VALUE ("Marcel", "Duchamp");
INSERT INTO auteurs (Nom, Prenom) VALUE ("Elisa", "Von Gloeden");
INSERT INTO auteurs (nom, prenom) VALUES ('Mapplethorpe', 'Gil');
INSERT INTO auteurs (nom, prenom) VALUES ('Renoir', 'Pierre-Auguste');

CREATE TABLE orientations(IdOrientation INT SERIAL PRIMARY KEY, Orientation VARCHAR (20));
INSERT INTO orientations (Orientation) VALUE ("portrait");
INSERT INTO orientations (Orientation) VALUE ("paysage");

CREATE TABLE images(IdImage INT SERIAL PRIMARY KEY, Nom VARCHAR (20), "Date" DATE, Orientation CONSTRAINT "fk_Orientation_Orientations" REFERENCES orientations(Orientation), Fichier VARCHAR (20), Likes INT DEFAULT 0, IdAuteur CONSTRAINT "fk_IdAuteur_auteurs" REFERENCES auteurs(IdAuteur));
...
CREATE TABLE commentaires(IdCommentaire INT SERIAL PRIMARY KEY, IdImage CONSTRAINT "fk_IdImage_images" REFERENCES images(IdImage), Texte VARCHAR (300));
